      ...
      <div
        ...
        <div className='resume-content mr-auto'>
          ...
          <div className='resume-date d-lg-none d-sm-block text-md-right mb-2'>
            <span
              className='text-primary'>{item.schoolYear + ' (' + getRelativeTime(item.startDate, item.endDate) + ')'}</span>
          </div>
          {item.description && (
            <>
              <div className='mb-2'>
          ...
          <div className='mb-2'>
            <FaBookmark className='text-warning m-right' />
            When I was a 2-year student, I did learn courses on <a target={'_blank'}
                                                                   href={'https://codelearn.io'}>CodeLearn</a>, such as
            Javascript Basic, C++ Basic, ...etc. <br />
